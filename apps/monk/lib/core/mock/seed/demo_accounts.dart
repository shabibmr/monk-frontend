...
void seedDemoAccounts(MockSeedStore store) {
  ...
  store.registerAccount(
    DemoAccount(
      ...
      // Must match the seeded OnboardingStatus for inf-demo-1 in
      // seed_profiles.dart (completed: true) — otherwise login bounces
      // between the dashboard and the wizard. Use the `newcreator`
      // persona to demo onboarding from scratch.
