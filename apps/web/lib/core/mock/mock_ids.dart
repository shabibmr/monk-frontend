...
abstract final class MockIds {
  ...
  static const emailCreator1 = 'demo.creator1@influencersmonk.local';
  static const emailManager1 = 'demo.manager1@influencersmonk.local';
  static const emailAgency1 = 'demo.agency1@influencersmonk.local';
  static const emailBrandFresh = 'demo.brand.fresh@influencersmonk.local';
  static const emailCreatorFresh = 'demo.creator.fresh@influencersmonk.local';
}
